...
<table width="1000" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    ...
    <td width="1027" align="center" valign="top"><table width="80%" border="1" cellspacing="0" cellpadding="0" align="center">
      <tr>
      ...
      <tr>
        ...
        <td><form id="form1" name="form1" method="post" action="addtocart.php">
          <input name="UserID" type="hidden" id="UserID" value="<?=$_SESSION["user"]?>" />
          <input name="ProductID" type="hidden" id="ProductID" value="<?=$row['ProductID']?>" />
  ...
  <tr>
    <td colspan="2"><img src="Footer.png" width="1363" height="80" /></td>
  </tr>
</table>
</body>
</html>
