<?php
	...
	$dateoforder = date("d/m/Y");
	  ...
	  {
		  $strSQL2 = "INSERT INTO `Mart`(`UserrID`, `ProductID`, `SellingPrice`, `DateOfOrder`) VALUES (".$_POST['UserID'].",".$row['ProductID'].",".$row['SellingPice'].",'".$dateoforder."')";
    	  $objQuery2 = mysqli_query($conn,$strSQL2);
	  }
	  $strSQL = "DELETE FROM `cart` WHERE `UserID`=".$_SESSION['user'];
      $objQuery = mysqli_query($conn,$strSQL);
?>
