<?php
	...
	$strSQL = "INSERT INTO `product`(`ProductID`, `NameOfProduct`, `SellingPice`) VALUES (".$_POST['ProductID'].",'".$_POST['NameOfProduct']."',".$_POST['Price'].")";
    $objQuery = mysqli_query($conn,$strSQL);
?>
<script>alert("คุณได้บันทึกสินค้าแล้ว");
