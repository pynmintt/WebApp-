...
<table width="1000" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <?php
    ...
    $strSQL = "SELECT * FROM `user` WHERE `UserID`=".$_POST['Uname']." AND `Password`='".$_POST['Pass']."'";
    ...
    {
      $_SESSION["user"] = $obResult["UserID"];
      $_SESSION["status"] = $obResult["Status"];
      $_SESSION["name"] = $obResult["NameOfUser"];
      session_write_close();
